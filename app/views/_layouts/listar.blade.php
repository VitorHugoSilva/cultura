        ...
        <tr class="table-crud-item">
            ...
            <td class="acoes">                        
                <div class="btn-group pull-right">
                    <a class="btn btn-default" title="Visualizar o registro" href="{{URL::action(Meta::getController() . '@' . 'exibir', [$model->id])}}">
                    <i class="fa fa-eye"></i> Detalhes
                    </a>

                    <a class="btn btn-default" title="Editaro registro" href="{{URL::action(Meta::getController() . '@editar', [$model->id])}}">
                    <i class="fa fa-pencil-square-o"></i> Editar
                    </a>
                    <a class="btn btn-danger modal-confirm-action action-delete" title="Deletar o registro" href="{{URL::action(Meta::getController() . '@deletar', [$model->id])}}", data-mensagem="Deseja realmente deletar?">
